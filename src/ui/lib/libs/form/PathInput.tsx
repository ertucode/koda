...
export type PathInputProps<TForm extends FieldValues> = {
  control: Control<TForm, any>;
  name: Path<TForm>;
} & Omit<React.ComponentProps<"input">, "value" | "onChange" | "locale">;
export function PathInput<TForm extends FieldValues>(
  props: PathInputProps<TForm>,
) {
  return (
    <Controller
      name={props.name}
